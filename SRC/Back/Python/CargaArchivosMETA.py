...
def main(argv):
    ...
    if len(sys.argv) < 2:
        print("INGRESE ENTRE COMILLAS DOBLES, EL NUMERO DE RFC ASOCIADO QUE VA PROCESAR DE LA METADATA")
        return
    ...
    for file in Archivos:
        ...
        if True in (Archivo.endswith('.txt'), Archivo.endswith('.txt')):
            ...
            for row in RESULTADOS:
                ...
                valores = (CVE_DESCARGA, ahora, ahora, RESULT[0], idrfc[0], 21)
