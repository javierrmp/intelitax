...
class Utils {
  ...
  public static function xmlToArray($xml){
    $str_json_array_decoded = json_decode(json_encode(simplexml_load_string(str_replace("s:", "", str_replace("o:","", str_replace("u:","",str_replace("h:","",'<?xml version="1.0" encoding="utf-8"?>'.$xml)))))),TRUE);
    return  $str_json_array_decoded;
  }
